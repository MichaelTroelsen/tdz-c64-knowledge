...
Examples:
  ...
  python cli.py stats
    ...
    translate_parser.add_argument("query", help="Natural language query (e.g., 'find sprite information')")
    translate_parser.add_argument("--confidence", "-c", type=float, default=0.7, help="Minimum confidence threshold (0.0-1.0, default: 0.7)")
