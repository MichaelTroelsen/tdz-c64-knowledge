...
page = st.sidebar.radio(
    "Navigation",
    ["📊 Dashboard", "📚 Documents", "🌐 Web Scraping", "🏷️ Tag Management", "🧠 Entity Extraction", "🔗 Relationship Graph", "📈 Entity Analytics", "📄 Document Comparison", "🔍 Search", "💾 Backup & Restore", "📉 System Analytics"]
)
