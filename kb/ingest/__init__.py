...
_EXPECTED_METHODS = frozenset({
    ...
    "_extract_text_for_file", "_extract_via_markitdown",
    "_extract_card_id", "_detect_and_extract_frames",
    "_extract_sid_file", "_extract_sid_archive", "_extract_deepsid_metadata",
    "_find_mdscrape_executable", "_extract_source_url_from_md",
    "_add_scraped_document", "add_deepsid_document", "add_deepsid_folder",
    "_add_deepsid_card", "_deepsid_folder_card", "_fetch_deepsid_folder",
    "_is_path_allowed", "get_document_by_card_id",
    ...
    "update_document", "update_document_title", "update_document_tags", "repoint_document",
